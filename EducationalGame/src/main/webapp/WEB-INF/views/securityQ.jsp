...
<form:form method= "POST" commandName="user" action="/passwordRecovery/resetPassword">
<center><h2> Forgot your Password ?</h2></center>
<p>Please fill in this to recover your account </p>
    <hr>
    <table align ="center">
		<tr>
      <td><form:label path="securityQuestion" ><b>Security Question:</b> ${securityQuestion}</form:label></td>
      ...
      <tr>
      <td>
            <input type="submit" value="Submit Answer" name="Answer" class="btn btn-default"/>
        </td>
